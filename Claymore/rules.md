...
## Checks
When the outcome is unclear, the keeper uses dice. If a player's character is trying to climb a 100ft tree without equipment, a keeper may ask for a check. The keeper gives a target number, and the player rolls a D20(twenty-sided die). If they hit or exceed the target number with their roll, they succeed.

## Skills
If an adventurer is proficient in a skill, they get a D6(six-sided die) bonus on checks relying on that skill. An adventurer might instead have expertise in a skill, in which case the bonus becomes 2d6(two six-sided dice). Half-proficiency grants a +2 bonus instead(does not stack). If one is proficient or has expertise with a weapon, their attack rolls gain the skill bonus. Skills can be as specific as sewing or lockpicking, or as general as those listed below.
- Athletics
- Acrobatics
- Sleight of Hand
- Stealth
...
You may now fly at the same speed you walk.
...
#### Slippery
You have advantage on checks to resist being grappled or restrained, and cannot be autograppled.

#### Grit Action: Improvised shield
...
#### Grit Action: Body Shield
You uses a grappled creature as a shield. You forfeit counter-attacks this turn, instead gaining a +10 to your defense rolls. Attacks that fail to hit you hit the grappled creature.

#### Grit Action: Redirection
When you grapple an attacking enemy, you may redirect their ranged attack to another creature, who must defend against the ranged attack roll.

#### Grit Action: Disarm
When you would successfully grapple a target, you may instead choose to swipe one of their held items.

#### Grit Action: Death Grip
...
#### School Specialization (Requires Wand Improvement)
You declare your specializion in one school of magic. You now have expertise in casting spells of that school. Additionally, you may now cast each of these spells one additional time per rest from your spellbook.
...
You take time to study a variety of topics and gain proficiency with nature, animal handling, medicine, and persuasion.

## Wizard Spell list

### 1 Fire Magic 
1. Fire bolt(C): You shoot a bolt of fire from your index finger.
2. Bonfire(C): You create a fire within a 5ft cube for one hour.
...
3. Create water(1st): Produce 100 gallons of water in container, as spray, or as rain over an area.
4. Ice Knife(1st): Fire a dagger of ice from your index finger. If the ice strikes a hard surface, it explodes into shards in a 10ft radius, forcing creatures to save to halve damage.
5. Ice Shards(2nd): Each of your fingers fires an ice shard. Targets must save, either to avoid damage if targeted with one hand, or to halve it if targeted with both hands.
6. Cone of Cold(3rd): Produce a 30ft cone of freezing energy which freezes up to a 30ft cube of ice. Creatures must save to halve damage.

### 3 Earth Magic
1. Shape Earth(C): You may move a 1 meter cube of soil up to 30 feet.
2. Acid Arrow(1st): You fire a bolt of acid from your index finger. A creature hit by the acid may save at the start of their turn to end the spell, or else take additional damage.
3. Grease(1st): Create slick patch(30ft square) of grease for 1 hour. If ignited, it burns for 1 minute.
4. Tremor(2nd): All stone surfaces within 60ft shatter violently, forcing creatures adjacent to them to save or take damage.
...
6. Shape Stone(3rd): Precisely carve stone that fits into a 10ft cube, creating up to five items in the process, or one large sculpture.

### 4 Air Magic
1. Shocking Grasp(C): Arcs of electricity leap from your fingertips up to 5ft away. Armor that is metal or wet is ineffective against this spell and grants targets disadvantage.
2. Gust(C): Create a strong gust of wind. You may focus it on one creature, forcing them to save to a void being knocked over.
3. Poison Spray(C): You create a 15ft cone of poison gas, forcing creatures to save or take damage.
...
6. Lightning Bolt(3rd): You join your palms and fire a bolt of lightning in a straight line. If a creature is hit, there is a 1 in 6 chance the bolt chains to an random creature within 10ft, and may chain multiple times. Armor that is metal or wet is ineffective against this spell and grants targets disadvantage.
...
2. Mind Spike(1st): Target saves or takes damage and reveals their location for the next 1 hour.
...
### 8 Conjuration Magic
1. Mage Hand(C): Produce magic flying hand that lifts up to 5lbs, 120ft range, 10 minutes.
2. Find Familiar(1st): A spirit takes the form of a varmint(1 heart, 1 damage) and follows your orders. Within 120ft, you may telepathically access its senses, ignoring your own fur the duration. Each wizard has only one familiar.
...
6. Polymorph(3rd): Transform a willing target into a different creature for 24 hours. Recast within 24 hours to make this change permanent. If used against an unwilling target, the target has advantage on each save.
...
4. Spell eater(2nd): Triggered using a reaction when targeted by a spell. Make a contested magic check. On success, the spell fails to cast and you regain the cost of casting spell eater.
5. Counterspell(3rd): Triggered using a reaction when another creature casts a spell. Creature must save, or else their spell is cast on them/centered on them.
6. Overcharged Spell(3rd): Scream the name of a spell while casting it and choose one effect: double range, double duration, double damage this turn, or advantage against target's save.
...
- Involuntary Nudist: Every article of clothing the target dons turns to dust
-  Bog Rot: Target is infected with a highly contagious skin condition. They do not regain hearts as a result of resting.
...
## Light Sources
- 1SP Candle 5ft radius, lasts 1 hour
- 1T Torch 30ft radius, lasts 1 hour
- 2C Oil Flask
...
- 2T Belt: can be worn around waist, across chest, or attach sheaths, sacks, pouches, purses
- 2T Belt Pouch: one pint, fixed to belt
- 1T Sack: one gallon, fixed to backpack
...
### Light(1AV)
- 7T Leather 5DV
- 5C Studded Leather 15AV

### Medium(2AV)
- 1C Wood shield 5DV
- 10C Steel Shield 15DV
- 1C Hide 5DV
- 50C Chain 10DV
- 500C Breastplate 20DV
...
## Adventuring Gear
These prices reflect a shopping trip to a major city's markets.
...
- 1C Barrel: 40 gallons
- 2C Cook's kit: iron pot filled with knife, cutting board, ladel, spatula 
- 1C Mess kit: two tin bowls twist closed around a tin cup and wooden teaspoon
- 5T 3-Person Tent
- 2T Bedroll

### Scholarly goods
- 10C Scholar's kit: quill pen, 10 sheets of paper, 1oz bottle of ink, bag of sand
- 5C Story book(half-proficiency with performance)
- 5C Holy book(half-proficiency with religion)
- 5C Book of lore(half-proficiency with history or magic)
- 5C Book of medicine(half-proficiency with medicine)
- 5C Wildlife guide(half-proficiency with nature and animal handling)
